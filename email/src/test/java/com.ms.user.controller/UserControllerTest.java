...
import com.ms.user.controller.CustomUtils;
...
public class UserControllerTest {
    ...
    public void getById() throws Exception {
        Mockito.when(userService.findById(ArgumentMatchers.anyUUID()))
    ...
    public void update() throws Exception {
        Mockito.when(userService.update(ArgumentMatchers.any(), ArgumentMatchers.anyUUID()))
                .thenReturn(UserBuilder.getDto());
        ...
        Mockito.verify(userService, Mockito.times(1))
                .update(ArgumentMatchers.any(UserDto.class), ArgumentMatchers.anyUUID());
        Mockito.verifyNoMoreInteractions(userService);
    }

    @Test
    public void delete() throws Exception {
        Mockito.doNothing().when(userService).deleteById(ArgumentMatchers.anyUUID());
